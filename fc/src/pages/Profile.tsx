...
export default function Profile() {
  ...
  async function handleProfileSave(e: React.FormEvent<HTMLFormElement>): Promise<void> {
    ...
    try {
      ...
      const stored: User = { ...currentUser, name: updated.name, email: updated.email };
  ...
  function handleAvatarColorChange(colorId: string): void {
  ...
  async function handlePasswordSave(e: React.FormEvent<HTMLFormElement>): Promise<void> {
    e.preventDefault();
    if (!currentPassword) {
