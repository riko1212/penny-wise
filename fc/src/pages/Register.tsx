...
function Register() {
  ...
  const handleRegister = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    const elements = e.currentTarget.elements as HTMLFormControlsCollection & {
      ...
      'email-name': HTMLInputElement;
      'login-pass': HTMLInputElement;
      'login-pass-repeat': HTMLInputElement;
    };
    const name = elements['login-name'].value.trim();
    const email = elements['email-name'].value.trim();
    const password = elements['login-pass'].value;
    const repeatPassword = elements['login-pass-repeat'].value;
